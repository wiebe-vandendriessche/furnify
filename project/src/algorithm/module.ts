export class Module {
    ...
    */
    public correct_size(height: number, length: number, width: number) {
        if(this.components.length >= 2)
            return ((this.height < height) && (this.width < width) && ((this.open + this.marge)< length)) || ((this.height < height) && (this.width < length) && ((this.open + this.marge) < width))
        return ((this.height < height) && ((this.width + this.marge)< width) && (this.open < length)) || ((this.height < height) && ((this.width + this.marge) < length) && (this.open < width));
    }
    ...
    */
    public correct_side(side: number) {
        if(this.components.length >= 2)
            return (((this.open + this.marge) < side)||(this.width < side))
        return ((this.open < side)||((this.width + this.marge) < side))
    }
